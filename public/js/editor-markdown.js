  ...
  , showEditor: function() {
      ...
      if (this.$editor == null) {
        ...
        if (options.savable) {
          ...
          $('div.white').prepend('<button class="btn save" data-provider="'
                              +ns
                              +'" data-handler="'
                              +saveHandler
        ...
        this.$editor.on('click', '[data-provider="editor-markdown"]', $.proxy(this.__handle, this))
        ...
        if (this.eventSupported('keydown') && typeof jQuery.hotkeys === 'object') {
          editorHeader.find('[data-provider="editor-markdown"]').each(function() {
            var $button = $(this),
